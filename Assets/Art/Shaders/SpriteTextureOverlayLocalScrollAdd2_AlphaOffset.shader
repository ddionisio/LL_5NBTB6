...
Shader "Game/Sprite/TextureOverlayLocalScrollAdd2_AlphaOffset"
{
	Properties
	{
		...
		_AlphaOfs("Alpha Offset", float) = 0
	}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 SpriteFrag_Overlay(v2fExt IN) : COLOR
			{
				...
				outClr.rgb = clamp((c.rrr * IN.color.rgb) + c.ggg * ((o.rgb * _OverlayColor.rgb * _OverlayColor.a * o.a) + (o2.rgb * _Overlay2Color.rgb * _Overlay2Color.a * o2.a)), 0, 1);

				outClr.a = clamp(c.a + _AlphaOfs, 0, 1) * c.b;
