...
Shader "Game/Sprite/Blob World Overlay Color Pulse"
{
	Properties
    {
	...
	SubShader
    {
        ...
        CGPROGRAM
			...
			v2fExt SpriteVert_Blob(appdata_t IN)
			{
				...
				float2 wtxt = mul(unity_ObjectToWorld, IN.vertex);
				OUT.texcoord2 = wtxt.xy * _OverlayScrollScale + _OverlayScrollParams.xy * _Time.y + half2(_OverlayScrollParams.z * _CosTime.w, _OverlayScrollParams.w * _SinTime.w);
				OUT.texcoord3 = wtxt.xy * _OverlayScroll2Scale + _OverlayScroll2Params.xy * _Time.y + half2(_OverlayScroll2Params.z * _CosTime.w, _OverlayScroll2Params.w * _SinTime.w);
